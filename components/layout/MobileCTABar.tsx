...
export function MobileCTABar() {
  return (
    <div
      className="fixed bottom-0 left-0 right-0 z-50 lg:hidden bg-white border-t border-[#E2DDD8] shadow-[0_-2px_16px_rgba(27,58,92,0.10)] px-4 py-3 flex gap-2"
      role="complementary"
    ...
    >
      ...
      <a
        ...
        className="flex-1 flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#1ebe5d] text-white font-semibold rounded-lg py-3 min-h-[48px] no-underline transition-colors"
