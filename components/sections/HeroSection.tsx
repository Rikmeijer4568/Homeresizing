  ...
  return (
    ...
    >
      <div className="container">
        {compact ? (
          /* Compact: gecentreerde paginaheader zonder afbeelding */
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 id="hero-heading" className="text-[#1B3A5C] mb-6">
              {title}
            </h1>
          ...
          /* Normaal: twee kolommen met tekst en afbeelding */
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 flex-wrap">
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#1ebe5d] text-white font-semibold text-lg px-8 py-4 rounded-lg transition-all duration-200 no-underline min-h-[56px]"
