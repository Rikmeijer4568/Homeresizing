      ...
      <div className="container text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center flex-wrap">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 bg-[#25D366] hover:bg-[#1ebe5d] text-white px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-200 no-underline min-h-[56px]"
